...
@synthesize star, highlightedStar, delegate, isFractionalRatingEnabled, tag1;
...
- (void)setupView {
	...
	currentIdx = -1;
    highlightedStar = [UIImage imageNamed:@"star.png"];
	star  = [UIImage imageNamed:@"star_highlighted.png"];
...
- (id)initWithFrame:(CGRect)frame andStars:(NSUInteger)_numberOfStars isFractional:(BOOL)isFract theTag: (NSString *) tag{
...
- (void)endTrackingWithTouch:(UITouch *)touch withEvent:(UIEvent *)event {
	[self.delegate newRating:self :self.rating :self.tag1];
